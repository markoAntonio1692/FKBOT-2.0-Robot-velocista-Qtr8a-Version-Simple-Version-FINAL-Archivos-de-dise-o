...
//////*********************
    ...
    void readCalibrated(unsigned int *sensor_values, unsigned char readMode = QTR_EMITTERS_ON, int flanco_sens=0);
    ...
    int readLine(unsigned int *sensor_values, unsigned char readMode = QTR_EMITTERS_ON,
	 unsigned char white_line = 0,int flanco_sens=0, int keep_track=200, int noise_threshold=50 );
